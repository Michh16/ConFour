...
public class AppUI extends AppCompatActivity implements UserInterface {
    ...
    public void onBackPressed() {
        ...
        tv.setText(" A game of Connect Four with 2 players!");
        layout.addView(tv);
        ...
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                AppUI.this.startGame(new ConGame(np.getValue()));
            }
        });
        layout.addView(b);
    ...
    public void startGame(final Game game) {
        ...
        class PosButton extends AppCompatButton {
            ...
            public void onMeasure(int wSpec, int hSpec) {
                ...
                setMeasuredDimension(w-55, w-55);
            }
        }
        ...
        for (int i = 0; i < ySize; i++) {
            ...
            row.setBackgroundColor(-16776961);
            for (int j = 0; j < xSize; j++) {
                Coordinate pos = new XYCoordinate(j, i);
                final PosButton b = new PosButton(pos);
                buttons.add(b);
                b.setText("");
                b.setOnClickListener(new View.OnClickListener() {
                    @Override
